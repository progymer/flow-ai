  ...
  return (
    ...
    >
        <Textarea 
            ...
            className="w-full h-full px-1! resize-none border-none bg-transparent
            focus-visible:ring-0 focus-visible:ring-offset-0 text-xs! shadow-none
            overflow-auto max-h-37.5 min-h-20 dark:text-black dark:placeholder:text-black"
        />
    </div>
  )
}
