...
import { NodeStatusIndicator } from "./react-flow-ui/node-status-indicator";
import { BaseNode, BaseNodeContent, BaseNodeHeader, BaseNodeHeaderTitle } from "./react-flow-ui/base-node";
...
const WorkflowNode = ({
  ...
  return (
    <>
      ...
      {settingComponent && (
        <Dialog open={settingOpen} onOpenChange={setSettingsOpen}>
          <DialogContent
